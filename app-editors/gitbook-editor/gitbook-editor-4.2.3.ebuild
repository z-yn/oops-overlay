...
MY_PN="gitbook-editor"
MY_P="${MY_PN}-${PV}"
SRC_URI="x86? ( http://downloads.editor.gitbook.com/download/gitbook-editor-${PV}-linux-ia32.deb )
	amd64? ( http://downloads.editor.gitbook.com/download/gitbook-editor-${PV}-linux-x64.deb )"
